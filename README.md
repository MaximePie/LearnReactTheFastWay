...
## Créer un formulaire de données riche 

Pour créer un formulaire hautement interactif, on va utiliser des states que nous allons analyser à chaque fois 
que leur valeur change. 
